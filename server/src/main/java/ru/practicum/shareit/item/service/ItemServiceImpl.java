...
public class ItemServiceImpl implements ItemService {
    ...
    private final ru.practicum.shareit.request.storage.ItemRequestRepository requestRepository;
    ...
    public ItemDto createItem(ItemDto itemDto, Long userId) {
        ...
        if (itemDto.getRequestId() != null) {
            item.setRequest(requestRepository.findById(itemDto.getRequestId())
                    .orElseThrow(() -> new NoSuchElementException("Запрос не найден: " + itemDto.getRequestId())));
        }
